...
Run 2026-08-29T14:48:06+00:00 against `https://d3t9yaye62k6ve.cloudfront.net`.
...
| Median latency | 2,023 ms | 4,890 ms | 5,036 ms |
| Planner tokens | 3,551 | 6,795 | 18,306 |
...
| 2 | `INC-1007` | remediate | remediate ok | remediate ok | remediate ok |
| 2 | `INC-1008` | remediate | remediate ok | remediate ok | remediate ok |
